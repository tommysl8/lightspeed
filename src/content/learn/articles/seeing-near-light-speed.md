...
In December 1725 James Bradley and his friend Samuel Molyneux began watching one star, γ Draconis, from Molyneux's house at Kew, west of London. A telescope more than 24 feet (7 m) long, made by the instrument maker George Graham, was fixed to a chimney stack, pointing straight up, because the star passes almost exactly overhead there and light coming from straight overhead is not bent by the air.[^rog1065][^perth2017] They were after parallax, the tiny yearly shuffle of a nearby star that would give its distance and prove that the Earth moves. [How far are the stars?](#/learn/how-far-are-the-stars) tells that part of the story.

The star did move. Over a year it swung about 20 arcseconds either side of its average position (a degree is 60 arcminutes and an arcminute is 60 arcseconds), but on the wrong timetable. Parallax should have pushed it furthest in June and December; γ Draconis was furthest out in March and September.[^rog1065] Bradley worked out why. The shift followed not where the Earth was, but which way it was going. A telescope carried sideways at orbital speed has to lean slightly forward to catch light falling in from a star, the way you tilt an umbrella forward when you walk through rain that falls straight down.
...
At 0.9c half of all the stars in the sky are packed into a twentieth of it. At 0.99c they fit in a circle 16° across, which you could hide behind two fists held at arm's length.
...
::: see-it split-0.999c
Left of the divider is the sky as it would look at rest; right of it is what you actually see at 0.999c, with half of all the stars crammed into a circle about 5° across ahead and the rear nearly empty.
:::
...
On 25 May 1842 Christian Doppler read a paper to the Royal Bohemian Society of Sciences in Prague. Five regular members turned up.[^nolte2020] The paper's title promised to explain the coloured light of double stars, and its subtitle billed it as an attempt at a more general theory that would contain Bradley's aberration theorem as one of its parts.[^doppler1842] Bradley had settled what motion does to the direction of light. Doppler wanted to know what it does to the timing. If you move towards a source, wave crests reach you more often and the frequency you measure goes up. Move away and it goes down.

The physics was right and the application was wrong. Doppler argued that the reds and blues of double stars came from their orbits carrying them towards or away from us.[^nolte2020] Stars move at tens of kilometres per second, about a ten-thousandth of light speed, which shifts their light by a hundredth of a per cent. A star's light also spreads across the whole spectrum, so sliding all of it a tiny amount changes the colour you see by almost nothing. Star colours come from temperature, as [What stars are made of](#/learn/what-stars-are-made-of) explains.
...
Einstein's 1905 paper added something Doppler could not have known about. A moving source is a moving clock, and moving clocks run slow by a factor γ, the Lorentz factor, which is 1 at rest and grows without limit as the speed approaches c ([Time dilation is real](#/learn/time-dilation)). So even light arriving from the side, from a source that is neither approaching nor receding along your line of sight, is shifted. Einstein proposed a test in 1907: watch the light of fast-moving ions in a gas discharge tube, a glass tube of thin gas made to glow by a high voltage.[^einstein1907]

It took 31 years. At Bell Telephone Laboratories, Herbert Ives and G. R. Stilwell sent a beam of hydrogen ions down a tube at under half a per cent of light speed and used a mirror to see the beam coming towards the spectrograph (which spreads light into a spectrum) and going away from it at the same time. The ordinary Doppler shifts, one blue and one red, cancel when you average them. What survives is the shift from time dilation alone, at most about one part in 100,000, and it matched the prediction.[^ives1938] The twist is that Ives was a committed opponent of relativity. He read the result as support for his own version of the ether, the invisible medium light was once thought to travel through.[^giuliani2015] Nature did not mind whose theory it was confirming. In 2014 a team at the GSI laboratory in Darmstadt ran a modern version with lithium ions circling a storage ring at 0.338c and matched Einstein's prediction to 2.3 parts per billion.[^botermann2014]

Put the old Doppler shift and the slow clocks together and you get the full rule for light reaching a ship from a star it sees at an angle θ′ from dead ahead.
...
The star you see at right angles is redshifted. The star that is at right angles in the stars' own frame is blueshifted, by the factor γ, because aberration has moved it to 25.8° from the point ahead. Both statements are true; they are about different stars.
:::
...
In words: the width of the back face you can now see, squared, plus the width of the squashed front face, squared, adds up to the cube's true width squared. That is Pythagoras, and it is exactly what a cube at rest looks like when it is turned about a vertical axis by an angle whose sine is β. (Turn a cube by an angle φ and its two visible faces look L sin φ and L cos φ wide.)
...
Before the laboratory came the software. Kraus and Corvin Zahn's simulations, begun in Tübingen, have shown flights past Saturn and through city streets at near light speed since the early 2000s,[^kraus2008] and in 2007 a team in Australia described Real Time Relativity, a program for flying through a simple world with the effects switched on.[^savage2007] In late 2012 the MIT Game Lab released A Slower Speed of Light, a free first-person game in which each orb you pick up lowers the speed of light until it approaches your own walking pace.[^mitgamelab] It shows the Doppler shift, the searchlight effect, time dilation, the distortion of shapes and the delay from light's travel time all at once, and it was built on OpenRelativity, an open-source toolkit anyone can build on.[^mitgamelab][^sherin2016]
...
To reach it, D has to be 798 ÷ 2.7255 = 293, which needs γ ≈ 146, a speed of 0.999977c. A ship holding 1 g from rest gets there after 5.5 years of ship time, having covered about 141 light-years. At that moment a dull red spot appears dead ahead where there was nothing. The spot is small, because D falls away quickly off-axis. Its temperature halves about 0.4° from the centre, so the warm patch is only about one and a half full Moons across, and the part hot enough to glow is smaller still. Keep accelerating and it whitens. It matches the Sun's colour at D ≈ 2,100 (γ ≈ 1,060), after 7.4 years of ship time and about 1,000 light-years. By then that small disc, together with its fading halo, delivers about 19 watts to each square metre of the ship's nose, a little more than sunlight gives at the distance of Saturn.
