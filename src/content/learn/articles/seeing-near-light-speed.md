...
- **2026:** The Event Horizon Telescope spends March and April trying to film the black hole in M87.
:::

## Starlight that leans

In December 1725 James Bradley and his friend Samuel Molyneux began watching one star from Molyneux's house at Kew, west of London. A 24-foot telescope by the instrument maker George Graham was fixed to the chimney, pointing straight up, because γ Draconis passes almost exactly overhead there and light coming from the zenith is not bent by the air.[^rog1065] They were after parallax, the tiny yearly shuffle of a nearby star that would give its distance and prove that the Earth moves. [How far are the stars?](#/learn/how-far-are-the-stars) tells that part of the story.
...
::: figure aberration
Twenty-four evenly spaced stars, at rest (left) and seen from a ship moving at 0.9c towards the top of the page (right). The twelve stars that filled the forward half now sit inside the 25.8° cone, tinted blue; the other twelve are spread around the back, tinted red.
:::
...
::: see-it split-0.999c
Left of the divider is the sky as pre-1905 physics would draw it at 0.999c; right of it is the real one. On the right, half of all the stars are crammed into a circle about 5° across ahead, and the rear is nearly empty.
:::
...
- Nolte, D. D., "The fall and rise of the Doppler effect", Physics Today 73 (3), 30–35 (2020). https://doi.org/10.1063/PT.3.4429 (the best short history of Doppler, Buys Ballot and Fizeau)
...
- [Relativistic Aberration Pt.1: Delayed perception](https://www.youtube.com/watch?v=QMuUDEK1c8A), Imagining Physics by Anssi Kuha, 7:00. Shows carefully why you never see a moving thing where it is now, the root of the Terrell rotation.
- [Relativistic Aberration Pt.2: Beaming Effect](https://www.youtube.com/watch?v=m3SCm2L823c), Imagining Physics by Anssi Kuha, 8:53. Works out where aberration comes from and how the relativistic version differs from the old one, with beaming as the payoff.
- [A Slower Speed of Light Official Trailer](https://www.youtube.com/watch?v=uu7jA8EHi_0), MIT Game Lab (channel: teamspectrip), 2:54. Three minutes of what a world with slow light looks like; then go and play the game.
- [Superluminal Speeds (faster than light)](https://www.youtube.com/watch?v=IsEDigUHsOQ), Sixty Symbols, 8:25. Mike Merrifield of the University of Nottingham on how things in the sky can appear to move faster than light without doing so.
- [How to Understand What Black Holes Look Like](https://www.youtube.com/watch?v=zUyH3XhpLTo), Veritasium, 9:18. Posted the day before the first EHT image came out; uses Jean-Pierre Luminet's 1979 simulated black hole to explain what such an image shows.
- [Imaging at a trillion frames per second](https://www.youtube.com/watch?v=Y_9vd4HWlVA), Ramesh Raskar, TED, 11:02. Films of light itself in motion, the family of techniques the Vienna experiment grew from.

### Online

- [Space Time Travel](https://www.spacetimetravel.org), Ute Kraus and Corvin Zahn. Films and explanations of flights past the Sun and Saturn, through the streets of Tübingen and towards black holes, with the physics spelled out.
- [A Slower Speed of Light](http://gamelab.mit.edu/games/a-slower-speed-of-light/), MIT Game Lab. Free downloads for Windows, Mac and Linux, plus the papers behind it.
...
- [Doppler's 1842 paper, scanned](https://archive.org/details/ueberdasfarbigel00doppuoft), Internet Archive (the 1903 centenary reprint).
...
[^giuliani2015]: G. Giuliani, "Experiment and theory: the case of the Doppler effect for photons", arXiv:1502.05736 (2015). https://arxiv.org/abs/1502.05736
...
[^kleinert2021]: A. Kleinert, "Anton Lampa: the man who brought Einstein to Prague", History of Sciences and Technology 54, 188–198 (2021). https://doi.org/10.70391/7e5.3-4.c
...
[^mitgamelab]: MIT Game Lab, "A Slower Speed of Light" (2012). http://gamelab.mit.edu/games/a-slower-speed-of-light/
...
[^bhex]: Black Hole Explorer (BHEX), Center for Astrophysics | Harvard & Smithsonian. https://bhex.cfa.harvard.edu
...
[^bashir2025]: M. Bashir, P. Chingangbam and S. Appleby, "The CatWISE2020 quasar dipole: a reassessment of the cosmic dipole anomaly", arXiv:2511.00822 (2025, revised 2026). https://arxiv.org/abs/2511.00822
