...
function Status() {
  ...
  return (
    <div className="mono flex shrink-0 items-center gap-3 whitespace-nowrap text-[10.5px] tracking-[0.06em]">
      <span>{text}</span>
      {showFps && (
...
export function Footer() {
  return (
    <footer className="app-ftr flex min-w-0 items-center gap-3 border-t border-line-2 bg-panel px-3">
      ...
      <Targets />
      <div className="h-4 w-px shrink-0 bg-line-2 max-md:hidden" />
